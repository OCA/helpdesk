...
class CustomerPortalHelpdesk(CustomerPortal):
    ...
    def portal_my_tickets(
        ...
        **kw
        ...
        domain = self._ticket_get_domain(filterby, searchbar_filters, date_begin, date_end, search_in, search)
    ...
    def _ticket_get_domain(self, filterby, searchbar_filters, date_begin, date_end, search_in, search):
