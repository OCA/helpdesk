...
class CustomerPortalHelpdesk(CustomerPortal):
    ...
    def _ticket_get_search_domain(self, search_in, search):
        ...
        if search_in in ("number", "all"):
            search_domain.append(Domain("number", "ilike", search))
        if search_in in ("name", "all"):
            search_domain.append(Domain("name", "ilike", search))
        return Domain.OR(search_domain) if search_domain else Domain.TRUE
